...
**'내가 만든 결과물이 타인의 경험에 미칠 영향'** 을 고민하는 것,
**'아직 모르는 것을 직접 부딪혀 만들어가는 즐거움'** 을 찾는 것입니다.
...
OperationKivotos(가제)는 4명의 캐릭터를 태그하여 전투를 진행하는 액션 RPG입니다. 실제 상용 게임 수준의 방대한 데이터를 효율적으로 관리하고 런타임 성능을 방어할 수 있는 아키텍처 구축에 집중한 프로젝트입니다.
