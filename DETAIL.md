...
- **플레이어에 대한 예의** 
  - 버그나 프레임 드랍은 플레이어의 몰입을 방해하는 '불친절'이라 생각합니다.
  - 원인이 무엇이든 퍼포먼스가 흔들리는 순간 타협하지 않고 끝까지 원인을 추적하는 것 - 그것이 저의 책임감입니다.

- **팀 프로젝트의 연결고리** 
  - 게임 클라이언트 프로그래머는 팀 전체의 결과물이 최종적으로 수렴되는 포지션입니다.
  - 혼자 작성한 코드라도 타인이 읽고 수정할 것을 염두에 두고 설계하는 것 — 그것이 협업이 시작되기 전부터 지킬 수 있는 책임이라 믿습니다.
...
- **목적이 이끄는 선택의 가치** 
  - 단순히 편한 길보다 **'무엇을 배울 수 있는가'** 와 **'직접 만드는 즐거움'** 이 제 선택의 기준입니다.
  - 목표에 대한 확신이 있다면, 기술적 난제나 수고로움은 성장을 위한 당연한 과정으로 즐깁니다.

- **불확실성 속에서 발견하는 몰입** 
  - 낯선 기술이나 치명적인 버그 앞에서 당황하기보다 본능적으로 원인을 파고듭니다.
